System.register(['angular2/core', 'angular2/http', 'angular2/router', './user.service'], function(exports_1) {
                ...
                UsersComponent.prototype.deleteUser = function (user) {
                    if (confirm("Are you sure you want to delete" + user.name + "?")) {
                        ...
                        this._service.deleteUser(user.id)
                            .subscribe(null, function (err) { return alert("Could not delete the user."); });
